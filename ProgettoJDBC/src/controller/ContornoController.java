...
public class ContornoController {
	...
	public Vector<Filamento> getObjcircle(float lat, float longit, float raggio) {
		// TODO Auto-generated method stub
		return ContornoDao.getObjCircle(lat,longit,raggio);
	}
	
	public Vector<Filamento> getObjSquare(float lat, float longit, float lato) {
		// TODO Auto-generated method stub
		return ContornoDao.getObjSquare(lat,longit,lato);
	}

	public List<Contorno> getContorniperId(Integer filamento_id) throws Exception {
	...
	public float[] getCentroide(Integer filamento_id) throws Exception {
		// TODO Auto-generated method stub
