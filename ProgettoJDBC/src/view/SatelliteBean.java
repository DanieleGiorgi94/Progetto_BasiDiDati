...
public class SatelliteBean {
	...
	public void insertSatellite() throws SatelliteEsistenteException, InfoSatelliteException, SQLException{
	...
	public void insertLastObs(String idSat, String lastObs) throws DataObbligatoriaException, IllegalLastObsException, SQLException{
	...
	public void insertAgenzia(String idSat, String agenzia) throws AgenziaObbligatoriaException, SQLException{
	...
	public List<Agenzia> getAgenzie() throws SQLException{
